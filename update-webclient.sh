...
wget https://download3.vmware.com/software/vmw-tools/vsphere_html_client/installer-$VER.0.bsx --no-check-certificate  # downloads the client and avoids cert check
